...
module.exports = {
    ...
    async execute(client, message, args){
        ...
        if(!quantity) return message.reply('Especifica la cantidad de '+emotes.coin+' **Bahrs** que deseas retirar');
        ...
        .setColor('DarkGreen')
        .setDescription(`${emotes.coin} ${(quantity === 'all' ? ballance.bank : quantity)} **Bahrs** han sido retiradas del banco`)
        .setTimestamp()
